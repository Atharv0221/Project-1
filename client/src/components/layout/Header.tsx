...
export default function Header() {
    ...
    return (
        <header className="h-16 border-b border-gray-800 bg-[#0B1120] flex items-center justify-between px-8 fixed top-0 right-0 left-64 z-40">
            {/* Search */}
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="text-right hidden md:block">
                        ...
                        <p className="text-[10px] text-cyan-400 font-bold uppercase tracking-wider">LEVEL {Math.floor(Math.random() * 20) + 1} SCHOLAR</p>
                    </div>
